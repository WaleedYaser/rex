...
SET REX_COMPILE_OPTIONS=%COMMON_COMPILE_OPTIONS% /Fe: rex /Fm: rex.map /LD
...
SET MAIN_COMPILE_OPTIONS=%COMMON_COMPILE_OPTIONS% /Fe: rex.exe /Fm: rex.map
...
@REM COPY %CODE_DIR%glew\bin\glew32.dll %BUILD_DIR%glew32.dll >nul 2>&1
